...
<p>   <h2>BSP Specific Parameters:</h2>
  ...
  <div class="row">
     <span class="field">
     <input type="hidden" name="property7name" value="bspbranch" /></span>
     <span class="label">BSP Git Branch:</span>
     <input type='text' name='property7value' value="master"/>
  </div>
  <div class="row">
     <span class="field">
     <input type="hidden" name="property8name" value="bsprevision" /></span>
     <span class="label">BSP Git Revision or Tag:</span>
     <input type='text' name='property8value' value="HEAD"/>
  </div>
  <div class="row">
     <span class="field">
     <input type="hidden" name="property9name" value="bspworkdir" /></span>
     <span class="label" type="hidden">BSP Workdir:</span>
     <input type='hidden' name='property9value' value="yocto/meta-intel"/>
  </div>
<!--
