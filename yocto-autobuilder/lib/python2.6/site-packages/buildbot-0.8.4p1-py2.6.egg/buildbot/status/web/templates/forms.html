...
-->
  ...
  <div class="row">
     ...
     <input type='text' value="HEAD" name='revision' />
  </div>

  <div class="row">
     <span class="field"><input type="hidden" name="property1name" value="yoctoabversion" /></span>
     <input type='hidden' value="postoecore" name="property1value" />
  </div>
...
<!--  <p>   <h2>BSP Specific Parameters:</h2>
  <hr />

  <div class="row">
     <span class="label">BSP Git Repo:</span>
     <span class="field">
     <input type="hidden" name="property6name" value="bsprepo" /></span>
     <span class="field">
     <input type='text' name='property6value' value=" "/>
     </span>
  </div>
  <div class="row">
     <span class="field">
     <input type="hidden" name="property7name" value="bsprepo" /></span>
     <span class="label">BSP Git Branch:</span>
     <input type='text' name='property7value' value=" "/>
  </div>
  <div class="row">
     <span class="field">
     <input type="hidden" name="property8name" value="bsprepo" /></span>
     <span class="label">BSP Git Revision or Tag:</span>
     <input type='text' name='property8value' value=" "/>
  </div>
  ...
  <div class="row">
     ...
     <span class="field"><input type="hidden" name="property9name" value="release" /></span>
     <span class="field"><input type="radio" name="property9value" /></span>
  </div>

  <div class="row">
     <span class="label">Continuously Build:</span>
     <span class="field"><input type="hidden" name="property10name" value="ci" /></span>
